...
$conexion =sqlsrv_connect ($serverName, $connectionInfo);
 ...
 $sql="INSERT INTO MANTENIMIENTOLOCATIVO VALUES ('$EQUIPO','$TIPO_DE_MANTENIMIENTO','$FECHA','$SERVICIO','$TIEMPO_EMPLEADO','$RESPONSABLE','$FECHA_PROGRAMACION','$FECHA_DE_ENTREGA','$TRABAJO_EJECUTADO')";
