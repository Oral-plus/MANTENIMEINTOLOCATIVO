...
$sql="SELECT * FROM MANTENIMIENTOLOCATIVO WHERE ORDEN='$id'";
                ...
                <div class="container mt-5">
                    <form action="update.php" method="POST">
                           ...
                           <label for="TRABAJO_EJECUTADO" class="formulario__label">FECHA TRABAJO_EJECUTADO:</label>
                                ...
                                <label for="OBSERVACION" class="formulario__label">SI SE SOLICITO COMPRA DE UN INSUMO INTRODUCIR EL VALOR::</label>
