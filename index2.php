...
<body>
    <form method="post" action="index2.php">
      ...
      <a href="index.php">  <input type="button" value="Inicio" class="inicio" name="btn3"></a>
    </center>
        </DIV>
...
if(isset($_POST['btn1']))
{
  ...
  sqlsrv_query($conexion, "INSERT INTO MANTENIMIENTOLOCATIVO (ORDEN,EQUIPO,TIPO_DE_MANTENIMIENTO,FECHA,SERVICIO,TIEMPO_EMPLEADO,RESPONSABLE,FECHA_PROGRAMACION,FECHA_DE_ENTREGA,TRABAJO_EJECUTADO,TIEMPO_EMPLEADO_FIN,OBSERVACION,VALOR_REPUESTO)
...
if(isset($_POST['btn2']))
{
    ...
    {  
      $resultados = sqlsrv_query($conexion,"SELECT * FROM MANTENIMIENTOLOCATIVO WHERE ORDEN = $ORDEN");
      ?>
     </div>
                            <table class="table" >
                                ...
                                <tbody>
                                  ...
                                  <tr><th>ORDEN</th> <th><?php  echo $row['ORDEN']?></th></tr>
                                         ...
                                         <tr>   <th>TRABAJO_EJECUTADO</th><th><?php  echo $row['TRABAJO_EJECUTADO']?></th></tr> 
                                               ...
                                               <tr>   <th>SI SE SOLICITO COMPRA DE UN INSUMO INTRODUCIR EL VALOR</th><th><?php  echo $row['VALOR_REPUESTO']?></th></tr>
