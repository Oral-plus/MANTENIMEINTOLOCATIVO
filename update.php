...
$sql="UPDATE MANTENIMIENTOLOCATIVO SET TIEMPO_EMPLEADO='$TIEMPO_EMPLEADO',TRABAJO_EJECUTADO='$TRABAJO_EJECUTADO',TIEMPO_EMPLEADO_FIN='$TIEMPO_EMPLEADO_FIN',OBSERVACION='$OBSERVACION',VALOR_REPUESTO='$VALOR_REPUESTO' WHERE ORDEN='$ORDEN'";
